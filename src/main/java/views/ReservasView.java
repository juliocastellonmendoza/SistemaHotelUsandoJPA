...
public class ReservasView extends JFrame {
	...
	public ReservasView() {
		...
		txtFechaSalida.addPropertyChangeListener(new PropertyChangeListener() {
			public void propertyChange(PropertyChangeEvent evt) {
				...
				if(evt.getOldValue()!=null) {
					...
					txtValor.setText(diferenciafechas());
		...
		txtValor.setEditable(false); // here cambie de false a true
	...
	public void insertar() {
		...
		if(txtValor.getText().length()==0) {
			JOptionPane.showMessageDialog(rootPane, "Debes ingresar el valor de la reserva");
			txtValor.requestFocus();
			return;
		}
		
		JOptionPane.showMessageDialog(rootPane, "La reserva fue registrada satifactoriamente");
	}
	...
	public String diferenciafechas() {
		...
		if (txtFechaEntrada.getCalendar()!= null) {
			finicial = sdf.format(txtFechaEntrada.getDate());
			localDateI = LocalDate.parse(finicial, DateTimeFormatter.ofPattern("yyyy/MM/dd"));
		}
		
		if (txtFechaSalida.getCalendar()!= null) {
			ffinal = sdfa.format(txtFechaSalida.getDate());
			localDateF = LocalDate.parse(ffinal, DateTimeFormatter.ofPattern("yyyy/MM/dd"));
		}
		
		if (txtFechaSalida.getCalendar()!= null && txtFechaEntrada.getCalendar()!= null) {
			Period period = Period.between(localDateI, localDateF);
			v = String.valueOf(period.getDays()*7.0);
		}
